...
TFLib.ModalPopup = function(config) {
    ...
    var modalpopup = {
        ...
        _applyProperty: function() {
            ...
            if (this.outerComp.setAttribute("data-zindex", 1e3 + currentPopupCount), "" != this.styles && Object.keys(this.styles).forEach(function(style) {
        ...
        _bindEvents: function() {
            this.scope;
            document.body.addEventListener("keyup", this._handleModalKeyUp), this._handleModalCloseBtnClick = this._handleModalCloseBtnClick.bind(this), 
        ...
        _handleModalKeyUp: function(e) {
            ...
            if (popups.length > 0) {
                ...
                "Escape" === e.key && (document.getElementById(itemId).querySelector(".tf-modal-close-btn").click(), 
                e.preventDefault());
            }
        },
        ...
        _destroy: function() {
            ...
            var currentPopupCount = document.getElementsByClassName("tf-modal-outer").length;
            currentPopupCount || document.body.removeEventListener("keyup", this._handleModalKeyUp);
        }
    };

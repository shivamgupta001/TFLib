...
!function() {
    ...
    var modalpopup = {
        ...
        _generateTemplate: function() {
            var el = [ '<div id="' + this.dynamicId + '" class="tf-modal-outer">', '<section class="tf-modal-inner" tabindex="1">', '<header class="tf-modal-header">', '<span class="tf-modal-title">' + this.title + "</span>", '<a  class= "tf-modal-close-btn"></a>', "</header>", '<section class="tf-modal-body"></section>', '<footer class="tf-modal-footer ' + (this.footerVisible ? "" : "tf-display--none") + '"></footer>', "</section>", "</div>" ].join("\n");

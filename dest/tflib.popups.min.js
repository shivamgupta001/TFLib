...
TFLib.TFConstants = {
    ...
    var modalpopup = {
        ...
        _initialize: function() {
            ...
            this.resizable = 0 != me.resizable, this.footerVisible = 1 == me.footerVisible, 
            this.width = me.width || 800, this.height = me.height || 600, this.styles = me.styles || "", 
            this.title = me.title || "", this.modalCloseCallback = me.modalOnClose || "", this.modalOpenCallback = me.modalOnOpen || "", 
    ...
    var standardpopup = {
        ...
        _bindEvents: function() {
            ...
            this.cancelComp.addEventListener("blur", this.handleCancelBlur)), Boolean(this.okComp) ^ Boolean(this.cancelComp) && document.addEventListener("keydown", this._handleKeyDown);
        },
        _attachProperties: function() {
            var me = this.scope;
        ...
        destroy: function() {
            ...
            this.cancelComp.removeEventListener("blur", this.handleCancelBlur)), Boolean(this.okComp) ^ Boolean(this.cancelComp) && document.removeEventListener("keydown", this._handleKeyDown);
        }
    };
    standardpopup._init();
};
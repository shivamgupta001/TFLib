...
TFLib.TFConstants = {
    ...
    var modalpopup = {
        ...
        _handleModalKeyUp: function(e) {
            ...
            if (popups.length > 0) {
                ...
                "Escape" !== e.key && "Esc" !== e.key || document.getElementById(itemId).querySelector(".tf-modal-close-btn").click();
            }
        },
    ...
    var standardpopup = {
        ...
        handleOkBlur: function(e) {
            ...
            this.shared.cancelComp.setAttribute("tabindex", 1e4), this.shared.okComp.setAttribute("tabindex", 10001)) : this.shared.okComp && this.shared.okComp.focus();
        },
        handleCancelBlur: function(e) {
            ...
            this.shared.okComp.setAttribute("tabindex", 1e4)) : this.shared.cancelComp && this.shared.cancelComp.focus();
        },

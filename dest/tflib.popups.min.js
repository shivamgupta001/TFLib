...
TFLib.ModalPopup = function(config) {
    ...
    var standardpopup = {
        ...
        _generateTemplate: function() {
            ...
            var elFooter = [ "<div>", this.OK ? '<input type="button" value="' + this.OKVal + '" ModalPopupOKBtn="true" autofocus>' : "", this.CANCEL ? '<input type="button" value="' + this.CANCELVal + '" ModalPopupCancelBtn="true">' : "", "</div>" ].join("\n");

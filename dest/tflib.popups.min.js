...
TFLib.TFConstants = {
        ...
        _handleModalKeyUp: function(e) {
            ...
            if (popups.length > 0) {
                var data = [].map.call(popups, function(value, index) {
                    var id = value.id, zindex = value.getAttribute("data-zindex"), obj = {};
    ...
    var standardpopup = {
        ...
        _render: function() {
            var me = this.scope, stdPopup = TFLib.ModalPopup({
                styles: {
                    minWidth: "400px",
                    maxWidth: "500px",
                    minHeight: "180px"
            ...
            stdPopup && stdPopup.show(), this.closeComp = document.getElementById(this.popupId).querySelector(".tf-modal-close-btn"), 
    ...
    var draggable = {
        ...
        _handleMouseDown: function(e) {
            if ((1 === $(this.elemEl).find(e.target).length || this.elemEl === e.target) && 2 !== e.buttons) {
                ...
                this.orgX = X - childLeft, this.orgY = Y - childTop, this.childEl.style.transform = "translate(0% , 0%)", 
        ...
        _handleMouseUp: function(e) {
            ...
            1 !== $(this.elemEl).find(e.target).length && this.elemEl !== e.target || 2 !== e.buttons && setTimeout(function() {

...
!function() {
    ...
    var standardpopup = {
        ...
        _initialize: function() {
            ...
            this.msg = me.msg, this.title = me.title, this.imgClassName = me.imgClassName, this.modalOnClose = me.modalOnClose || "", 
    ...
    var draggable = {
        ...
        _bindEvents: function() {
            ...
            this._handleContext = this._handleContext.bind(this), this.childEl.addEventListener("contextmenu", this._handleContext);
        },
        _handleMouseDown: function(e) {
            ...
            this.childEl.style.cursor = "move", this.orgX = X - childLeft, this.orgY = Y - childTop, 
            this._handleMouseMove = this._handleMouseMove.bind(this), document.addEventListener("mousemove", this._handleMouseMove), 
            document.addEventListener("mouseup", this._handleMouseUp), e.preventDefault();
        },
        ...
        _handleMouseUp: function(e) {
            console.log("mouse up"), document.removeEventListener("mousemove", this._handleMouseMove), 
            this.childEl.style.cursor = "default", setTimeout(function() {
                this.activeEl.focus();

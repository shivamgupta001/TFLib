    ...
    var draggable = {
        ...
        _handleMouseDown: function(e) {
            if ((1 === $(this.elemEl).find(e.target).length || this.elemEl === e.target) && 2 !== e.buttons) {
                console.log("mouse down"), console.log(e), this.activeEl = document.activeElement;
        ...
        _handleMouseUp: function(e) {
            1 !== $(this.elemEl).find(e.target).length && this.elemEl !== e.target || 2 !== e.buttons && (document.removeEventListener("mousemove", this._handleMouseMove), 

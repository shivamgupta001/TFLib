...
TFLib.TFButtonMethods = function() {
    ...
    this.displayLabelHide = function() {
        ...
        return this.isValidated = !0, Object.keys(this.validations).forEach(function(val) {
    ...
    var button = {
        ...
        _generateTemplate: function() {
            var el = [ "<div>", '<button control-type="tf-btn"', 'id="' + this.dynamicId + '"', 'class="tf-button"', "></button>", "</div>" ].join("\n");
    ...
    var checkboxfield = {
        ...
        _initialize: function() {
            ...
            this.requiredId = "tf-chk-req-" + getRandomInt(1, 1e4), this.markRequired = me.markRequired || !1, 
    ...
    var radio = {
        ...
        _generateTemplate: function() {
            var el = [ '<div class="tf-flex ' + ("row" === this.fieldLayout ? "tf-flex-direction--row " : "tf-flex-direction--column ") + '">', '<input control-type="tf-radio" id="' + this.dynamicId + '" type="radio" ' + (this.checked ? "checked" : "") + "/>", '<label control-type="tf-radio-label" for="' + this.dynamicId + '">' + this.fieldLabel + "</label>", "</div>" ].join("\n");
            this.childTemplate = $(el)[0];
        },
        _cacheDom: function() {
    ...
    var radiofield = {
        ...
        _generateTemplate: function() {
            var el = [ '<div id="' + this.dynamicId + '"', 'class="tf-flex ' + ("row" === this.fieldLayout ? "tf-flex-direction--row " : "tf-flex-direction--column ") + '">', '<div control-type="tf-radiof-label" class="' + ("none" === this.displayLabel ? "tf-display--none" : "") + '">', '<label id="' + this.labelId + '">' + (this.fieldLabel ? this.fieldLabel : "") + "</label>", '<span id="' + this.requiredId + '" class="tf-required--red" style="display:none;">*</span>', "</div>", '<div control-type="tf-radiofield" class="tf-flex ' + ("row" === this.groupLayout ? "tf-flex-direction--row " : "tf-flex-direction--column ") + '">', "</div>", "</div>" ].join("\n");
            this.childTemplate = $(el)[0];
        },
        _cacheDom: function() {
    ...
    var textfield = {
        ...
        _initialize: function() {
            var me = this.scope;
            this.dynamicId = me.id || "tf-textfield-" + getRandomInt(1, 1e4), this.innerId = me.innerId || "tf-input-text-" + getRandomInt(1, 1e4), 
    ...
    var comboboxfield = {
        ...
        _generateTemplate: function() {
            var el = [ "<div", 'id="' + this.dynamicId + '"', 'class="tf-flex ' + ("row" === this.fieldLayout ? "tf-flex-direction--row " : "tf-flex-direction--column ") + '">', '<div control-type="tf-combo-label" class="tf-flex ' + (this.displayLabel ? "tf-display--none" : "") + '">', '<label id="' + this.labelId + '">' + (this.fieldLabel ? this.fieldLabel : "") + "</label>", '<span id="' + this.requiredId + '" class="tf-required--red" style="display:none;">*</span>', "</div>", '<div control-type="tf-combofield" class="tf-field-with-btn tf-flex--one tf-border--none" >', '<select class="tf-flex tf-flex--one"', 'type="text"', "" + (this.name ? 'name="' + this.name + '"' : ""), "" + (this.tabindex ? 'tabindex="' + this.tabindex + '"' : ""), "" + this.multiple, "></select>", "</div>", "</div>" ].join("\n");
            this.childTemplate = $(el)[0];
        },
        _cacheDom: function() {
        ...
        _attachProperties: function() {
            ...
            TFLib.TFCheckboxFieldMethods.call(me), TFLib.TFSharedMethods.call(me), this.outerComp.shared = me, 
            me.validationMethods = {}, TFLib.TFValidations.call(me.validationMethods), Object.keys(this.validations).length > 0 && this.setValidations.call(me);
        },
        setValidations: function() {
            Object.keys(this.validations).forEach(function(val) {
                switch (val) {

...
TFLib.TFButtonMethods = function() {
    ...
    this.displayLabelHide = function() {
        ...
        for (var chkstatus = !1, i = 0; i < this.innerComp.length; i++) if (this.innerComp[i].checked) {
            chkstatus = !0;
            break;
        }
        chkstatus ? (this.controlComp.classList.remove("tooltip", "tf-err-border--red"), 
        this.controlComp.removeAttribute("data-tooltip")) : this.validations.hasOwnProperty("customError") ? (this.validations.customError.value = status, 
    ...
    var checkbox = {
        ...
        _initialize: function() {
            ...
            this.name = me.name || "", this.fieldLabel = me.fieldLabel || "", this.labelClass = !!me.labelClass && (me.labelClass.constructor === Array ? me.labelClass : [ me.labelClass ]), 
        ...
        _generateTemplate: function() {
            var el = [ '<div class="tf-flex ' + ("row" === this.fieldLayout ? "tf-flex-direction--row " : "tf-flex-direction--column ") + '">', '<input control-type="tf-checkbox" id="' + this.dynamicId + '" type="checkbox">', '<label control-type="tf-chk-label" for="' + this.dynamicId + '">' + this.fieldLabel + "</label>", "</div>" ].join("\n");
            this.childTemplate = $(el)[0];
        },
        _cacheDom: function() {
    ...
    var container = {
        ...
        _initialize: function() {
            var me = this.scope;
            this.dynamicId = me.id || "tf-container-" + getRandomInt(1, 1e4), this.layout = me.layout || "row", 
        ...
        _generateTemplate: function() {
            ...
            el.classList.add("tf-flex"), el.setAttribute("control-type", "tf-container"), el.setAttribute("id", this.dynamicId), 
        ...
        _applyProperty: function() {
            ...
            "row" === this.layout ? this.outerComp.classList.add("tf-flex-direction--row") : this.outerComp.classList.add("tf-flex-direction--column"), 
    ...
    var radio = {
        ...
        _generateTemplate: function() {
            var el = [ '<div class="tf-flex ' + ("row" === this.fieldLayout ? "tf-flex-direction--row " : "tf-flex-direction--column ") + '">', '<input control-type="tf-radio" id="' + this.dynamicId + '" type="radio"/>', '<label control-type="tf-radio-label" for="' + this.dynamicId + '">' + this.fieldLabel + "</label>", "</div>" ].join("\n");
            this.childTemplate = $(el)[0];
        },
        _cacheDom: function() {

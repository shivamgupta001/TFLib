...
TFLib.TFButtonMethods = function() {
    ...
    this.isRequired = function(e) {
        ...
        if ("blur" === e.type) "" === controlVal ? (control.classList.add("tooltip", "tf-err-border--red"), 
        ...
        control.removeAttribute("data-tooltip"), inputControl.setAttribute("title", this.validations.isRequired.errmsg)); else if ("input" === e.type) controlVal.length > 0 && control.getAttribute("data-tooltip") === this.validations.isRequired.errmsg ? control.classList.contains("tooltip") && (control.classList.remove("tooltip", "tf-err-border--red"), 
        control.removeAttribute("data-tooltip"), inputControl.setAttribute("title", this.validations.isRequired.errmsg)) : "" !== controlVal && "\n" !== controlVal || (control.classList.add("tooltip", "tf-err-border--red"), 
        ...
        if (this.validations.regex.value) {
            var regex = new RegExp(this.validations.regex.pattern);
            "blur" !== e.type && "input" !== e.type || controlVal.length > 0 && (regex.test(controlVal) ? control.classList.contains("tooltip") && (control.classList.remove("tooltip", "tf-err-border--red"), 

...
TFLib.TFButtonMethods = function() {
    ...
    var button = {
        ...
        _initialize: function() {
            var me = this.scope;
            this.dynamicId = me.id || "tf-btn-" + (new Date().getTime() + "" + getRandomInt(1, 1e3)), 
    ...
    var checkbox = {
        ...
        _initialize: function() {
            var me = this.scope;
            this.dynamicId = me.id || "tf-chk-" + (me.attributes && me.attributes.name ? me.attributes.name : "") + (new Date().getTime() + "" + getRandomInt(1, 1e3)), 
    ...
    var checkboxfield = {
        ...
        _initialize: function() {
            var me = this.scope;
            this.dynamicId = me.id || "tf-chkf-" + (new Date().getTime() + "" + getRandomInt(1, 1e3)), 
            this.labelId = me.labelId || "tf-chk-label-" + (new Date().getTime() + "" + getRandomInt(1, 1e3)), 
            this.requiredId = "tf-chk-req-" + (new Date().getTime() + "" + getRandomInt(1, 1e3)), 
    ...
    var container = {
        ...
        _initialize: function() {
            var me = this.scope;
            this.dynamicId = me.id || "tf-container-" + (new Date().getTime() + "" + getRandomInt(1, 1e3)), 
    ...
    var radio = {
        ...
        _initialize: function() {
            var me = this.scope;
            this.dynamicId = me.id || "tf-radio-" + (me.attributes && me.attributes.name ? me.attributes.name : "") + (new Date().getTime() + "" + getRandomInt(1, 1e3)), 
            this.fieldLayout = me.fieldLayout || "row", this.styles = me.styles || "", this.attributes = me.attributes || "", 
            this.name = me.name || "", this.checked = me.checked === !0, this.fieldLabel = me.fieldLabel || "", 
            this.labelClass = !!me.labelClass && (me.labelClass.constructor === Array ? me.labelClass : [ me.labelClass ]), 
            this.compClass = !!me.compClass && (me.compClass.constructor === Array ? me.compClass : [ me.compClass ]), 
    ...
    var radiofield = {
        ...
        _initialize: function() {
            var me = this.scope;
            this.dynamicId = me.id || "tf-radiof-" + (new Date().getTime() + "" + getRandomInt(1, 1e3)), 
            this.labelId = me.labelId || "tf-radio-label-" + (new Date().getTime() + "" + getRandomInt(1, 1e3)), 
            this.requiredId = "tf-radio-req-" + (new Date().getTime() + "" + getRandomInt(1, 1e3)), 
            this.fieldLayout = me.fieldLayout || "row", this.styles = me.styles || "", this.fieldGroup = me.fieldGroup || [], 
            this.groupLayout = me.groupLayout || "column", this.name = me.name || "", this.validations = me.validations || {}, 
            this.validations.__proto__ = {
                isRequired: {
    ...
    var textareafield = {
        ...
        _initialize: function() {
            var me = this.scope;
            this.dynamicId = me.id || "tf-ta-comp-" + (new Date().getTime() + "" + getRandomInt(1, 1e3)), 
            this.innerId = me.innerId || "tf-ta-" + (new Date().getTime() + "" + getRandomInt(1, 1e3)), 
            this.requiredId = "tf-ta-req-" + (new Date().getTime() + "" + getRandomInt(1, 1e3)), 
    ...
    var textfield = {
        ...
        _initialize: function() {
            var me = this.scope;
            this.dynamicId = me.id || "tf-textfield-" + (new Date().getTime() + "" + getRandomInt(1, 1e3)), 
            this.innerId = me.innerId || me.name || "tf-input-text-" + (new Date().getTime() + "" + getRandomInt(1, 1e3)), 
            this.requiredId = "tf-input-req-" + (new Date().getTime() + "" + getRandomInt(1, 1e3)), 
    ...
    var comboboxfield = {
        ...
        _initialize: function() {
            var me = this.scope;
            this.dynamicId = me.id || "tf-combo-" + (new Date().getTime() + "" + getRandomInt(1, 1e3)), 
            this.labelId = me.labelId || "tf-combo-label-" + (new Date().getTime() + "" + getRandomInt(1, 1e3)), 
            this.requiredId = "tf-combo-req-" + (new Date().getTime() + "" + getRandomInt(1, 1e3)), 
            this.buttons = me.buttons || [], this.validations = me.validations || {}, this.validations.__proto__ = {
                isRequired: {
                    value: !1,
                    errmsg: TFLib.TFConstants.COMMON.ISREQUIRED

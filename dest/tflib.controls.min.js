...
"selectedOptions" in document.createElement("select") || Object.defineProperty(HTMLSelectElement.prototype, "selectedOptions", {
    ...
    this.displayLabelHide = function() {
        ...
        return this.isValidated = !0, this.validations && Object.keys(this.validations).forEach(function(val) {
            ...
            this.controlComp.removeAttribute("data-tooltip", this.validations.isRequired.errmsg)); else if ("regex" === val) {
                if (this.validations.regex.value) {
                    var regex = new RegExp(this.validations.regex.pattern);
                    regex.test(this.innerComp.value) ? (this.controlComp.classList.removemany([ "tooltip", "tf-err-border--red" ]), 
                    this.controlComp.removeAttribute("data-tooltip", this.validations.regex.errmsg)) : (this.controlComp.classList.addmany([ "tooltip", "tf-err-border--red" ]), 
                    this.controlComp.setAttribute("data-tooltip", this.validations.regex.errmsg), this.isValidated = !1);
                }
    ...
    this.isRequired = function(e) {
        ...
        if ("blur" == e.type && (blurRegexFirstRun = !0), this.validations.regex.value) {
            var regex = this.validations.regex.pattern;
            regex = new RegExp(regex), !blurRegexFirstRun || "blur" !== e.type && "input" !== e.type || controlVal.length > 0 && (regex.test(controlVal) ? control.classList.contains("tooltip") && (this.validations.customError.value ? control.setAttribute("data-tooltip", this.validations.customError.errmsg) : (control.classList.removemany([ "tooltip", "tf-err-border--red" ]), 
            control.removeAttribute("data-tooltip"))) : (control.classList.addmany([ "tooltip", "tf-err-border--red" ]), 

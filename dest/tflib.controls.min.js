...
"selectedOptions" in document.createElement("select") || Object.defineProperty(HTMLSelectElement.prototype, "selectedOptions", {
    ...
    this.displayLabelHide = function() {
        ...
        this.validations.isRequired.value ? errmsg && (this.validations.isRequired.errmsg = errmsg) : this.validations.customError.value || (this.controlComp.classList.removemany([ "tooltip", "tf-err-border--red" ]), 
    ...
    this.addInnerClass = function(newClass) {
        ...
        this.outerComp.style.display = "table", this.activeElement = document.activeElement, 
    ...
    this.displayLabelHide = function() {
        ...
        return this.isValidated = !0, this.validations && Object.keys(this.validations).forEach(function(val) {
            if ("isRequired" === val && this.validations[val].value === !0) {
                ...
                this.controlComp.setAttribute("data-tooltip", this.validations.isRequired.errmsg), 
                this.isValidated = !1; else if (this.validations.customError.value) this.controlComp.setAttribute("data-tooltip", this.validations.customError.errmsg); else if (this.validations.regex.value) {
                ...
                if (this.validations.regex.value) {
                    ...
                    this.controlComp.setAttribute("data-tooltip", this.validations.regex.errmsg), this.isValidated = !1) : this.innerComp.value.length > 0 && (this.validations.customError.value ? this.controlComp.setAttribute("data-tooltip", this.validations.customError.errmsg) : (this.controlComp.classList.removemany([ "tooltip", "tf-err-border--red" ]), 
    ...
    this.isRequired = function(e) {
        ...
        control.setAttribute("data-tooltip", this.validations.isRequired.errmsg)) : control.classList.contains("tooltip") && (this.validations.customError.value ? control.setAttribute("data-tooltip", this.validations.customError.errmsg) : this.validations.regex.value ? control.setAttribute("data-tooltip", this.validations.regex.errmsg) : (control.classList.removemany([ "tooltip", "tf-err-border--red" ]), 
        control.removeAttribute("data-tooltip"))); else if (this.isRequired.blurFirstRun && "input" === e.type) controlVal.length > 0 && control.getAttribute("data-tooltip") === this.validations.isRequired.errmsg ? control.classList.contains("tooltip") && (this.validations.customError.value ? control.setAttribute("data-tooltip", this.validations.customError.errmsg) : (control.classList.removemany([ "tooltip", "tf-err-border--red" ]), 
        ...
        if ("blur" === e.type && (this.regex.blurFirstRun = !0), this.validations.regex.value) {
            ...
            regex = regex.replace(/\\d/g, "[0-9]"), regex = new RegExp(regex), !this.regex.blurFirstRun || "blur" !== e.type && "input" !== e.type || (controlVal.length > 1 ? regex.test(controlVal) ? control.classList.contains("tooltip") && (this.validations.customError.value ? control.setAttribute("data-tooltip", this.validations.customError.errmsg) : (control.classList.removemany([ "tooltip", "tf-err-border--red" ]), 
            control.removeAttribute("data-tooltip"))) : (control.classList.addmany([ "tooltip", "tf-err-border--red" ]), 
    ...
    var container = {
        ...
        _generateTemplate: function() {
            var el = [ '<div control-type="tf-container" class="tf-field-container" id="' + this.dynamicId + '">', "</div>" ].join("\n");
            this.childTemplate = $(el)[0];
        },
        _cacheDom: function() {
        ...
        _applyProperty: function() {
            ...
            this.compClass && this.outerComp.classList.addmany(this.compClass), this.layout && this.outerComp.classList.add("tf-flex"), 

...
TFLib.TFButtonMethods = function() {
    this.replaceText = function(newText) {
        ...
        newClass = newClass.constructor === Array ? newClass : [ newClass ], this.innerComp.classList.add.apply(this.innerComp.classList, newClass);
    }, this.removeInnerClass = function(oldClass) {
        oldClass = oldClass.constructor === Array ? oldClass : [ oldClass ], this.innerComp.classList.remove.apply(this.innerComp.classList, oldClass);
    ...
    this.displayLabelHide = function() {
        ...
        newClass = newClass.constructor === Array ? newClass : [ newClass ], this.labelComp.classList.add.apply(this.labelComp.classList, newClass);
    }, this.removeLabelClass = function(oldClass) {
        oldClass = oldClass.constructor === Array ? oldClass : [ oldClass ], this.labelComp.classList.remove.apply(this.labelComp.classList, oldClass);
    }, this.addControlClass = function(newClass) {
        newClass = newClass.constructor === Array ? newClass : [ newClass ], this.controlComp.classList.add.apply(this.controlComp.classList, newClass);
    }, this.removeControlClass = function(oldClass) {
        oldClass = oldClass.constructor === Array ? oldClass : [ oldClass ], this.controlComp.classList.remove.apply(this.controlComp.classList, oldClass);
        ...
        this.validations.customError.value || this.controlComp.setAttribute("data-tooltip", this.validations.isRequired.errmsg)) : this.validations.customError.value || (this.controlComp.classList.remove("tooltip", "tf-err-border--red"), 
        ...
        this.controlComp.classList.add("tooltip", "tf-err-border--red"), this.controlComp.setAttribute("data-tooltip", this.validations.customError.errmsg)) : (this.controlComp.classList.remove("tooltip", "tf-err-border--red"), 
        ...
        this.controlComp.classList.add("tooltip", "tf-err-border--red"), this.controlComp.setAttribute("data-tooltip", this.validations.customError.errmsg));
    }, this.validate = function() {
        return this.isValidated = !0, this.validations && Object.keys(this.validations).forEach(function(val) {
            if ("isRequired" === val) this.validations.isRequired.value && (this.controlComp.classList.add("tooltip", "tf-err-border--red"), 
            ...
            this.isValidated = !1); else if ("regex" === val) {
                if (this.validations.regex.value) {
                    ...
                    regex.test(this.innerComp.value) || (this.controlComp.classList.add("tooltip", "tf-err-border--red"), 
    ...
    this.hide = function() {
        ...
        newClass = newClass.constructor === Array ? newClass : [ newClass ], this.outerComp.classList.add.apply(this.outerComp.classList, newClass);
    }, this.removeClass = function(oldClass) {
        oldClass = oldClass.constructor === Array ? oldClass : [ oldClass ], this.outerComp.classList.remove.apply(this.outerComp.classList, oldClass);
    ...
    this.displayLabelHide = function() {
        ...
        this.validations.hasOwnProperty("onlyText") ? this.validations.onlyText.value = status : status && (Object.defineProperty(this.validations, "onlyText", {
            value: {},
            writable: !0,
            configurable: !0,
            enumerable: !0
        }), this.validations.onlyText.value = status), this.setValidations.call(this);
    }, this.onlyNumber = function(status) {
        this.validations.hasOwnProperty("onlyNumber") ? this.validations.onlyNumber.value = status : status && (Object.defineProperty(this.validations, "onlyNumber", {
            value: {},
            writable: !0,
            configurable: !0,
            enumerable: !0
        }), this.validations.onlyNumber.value = status), this.setValidations.call(this);
        ...
        pattern && (this.validations.regex.pattern = pattern)) : this.validations.customError.value || (this.controlComp.classList.remove("tooltip", "tf-err-border--red"), 
        ...
        return this.isValidated = !0, this.validations && Object.keys(this.validations).forEach(function(val) {
            if ("isRequired" === val) 0 == this.innerComp.value.trim().length && (this.controlComp.classList.add("tooltip", "tf-err-border--red"), 
            this.controlComp.setAttribute("data-tooltip", this.validations.isRequired.errmsg), 
            this.isValidated = !1); else if ("regex" === val) {
                if (this.validations.regex.value) {
                    var regex = new RegExp(this.validations.regex.pattern);
    ...
    this.isRequired = function(e) {
        var control = this.controlComp, inputControl = this.innerComp;
        if ("blur" === e.type) "" === e.target.value ? (control.classList.add("tooltip", "tf-err-border--red"), 
        control.setAttribute("data-tooltip", this.validations.isRequired.errmsg), inputControl.setAttribute("title", this.validations.isRequired.errmsg)) : control.classList.contains("tooltip") && (control.classList.remove("tooltip", "tf-err-border--red"), 
        control.removeAttribute("data-tooltip"), inputControl.setAttribute("title", this.validations.isRequired.errmsg)); else if ("input" === e.type) e.target.value.length > 0 && control.getAttribute("data-tooltip") === this.validations.isRequired.errmsg ? control.classList.contains("tooltip") && (control.classList.remove("tooltip", "tf-err-border--red"), 
        control.removeAttribute("data-tooltip"), inputControl.setAttribute("title", this.validations.isRequired.errmsg)) : "" === e.target.value && (control.classList.add("tooltip", "tf-err-border--red"), 
        control.setAttribute("data-tooltip", this.validations.isRequired.errmsg), inputControl.setAttribute("title", this.validations.isRequired.errmsg)); else if ("change" === e.type) {
            for (var chkStatus = !1, i = 0; i < inputControl.length; i++) if (inputControl[i].checked) {
                chkStatus = !0;
                break;
            }
            chkStatus ? (control.classList.remove("tooltip", "tf-err-border--red"), control.removeAttribute("data-tooltip")) : (control.classList.add("tooltip", "tf-err-border--red"), 
        ...
        if (this.validations.regex.value) {
            var regex = new RegExp(this.validations.regex.pattern);
            "blur" !== e.type && "input" !== e.type || e.target.value.length > 0 && (regex.test(e.target.value) ? control.classList.contains("tooltip") && (control.classList.remove("tooltip", "tf-err-border--red"), 
            control.removeAttribute("data-tooltip"), inputControl.setAttribute("title", this.validations.regex.errmsg)) : (control.classList.add("tooltip", "tf-err-border--red"), 
            control.setAttribute("data-tooltip", this.validations.regex.errmsg), inputControl.setAttribute("title", this.validations.regex.errmsg)));
        }
    };
    ...
    var button = {
        ...
        _initialize: function() {
            var me = this.scope;
            this.dynamicId = me.id || "tf-btn-" + getRandomInt(1, 1e4), this.styles = me.styles || "", 
            this.attributes = me.attributes || "", this.compClass = !!me.compClass && (me.compClass.constructor === Array ? me.compClass : [ me.compClass ]), 
        ...
        _generateTemplate: function() {
            var el = [ '<div class="tf-field-container">', '<button control-type="tf-btn"', 'id="' + this.dynamicId + '"', 'class="tf-button"', "></button>", "</div>" ].join("\n");
        ...
        _applyProperty: function() {
            ...
            }, this), this.btnText && (this.innerComp.innerHTML = this.btnText), this.btnClass && this.innerComp.classList.add.apply(this.innerComp.classList, this.btnClass), 
            this.compClass && this.outerComp.classList.add.apply(this.outerComp.classList, this.compClass);
        },
    ...
    var checkbox = {
        ...
        _initialize: function() {
            var me = this.scope;
            this.dynamicId = me.id || "tf-chk-" + (me.attributes && me.attributes.name ? me.attributes.name : "") + getRandomInt(1, 1e4), 
        ...
        _generateTemplate: function() {
            var el = [ '<div class="tf-flex ' + ("row" === this.fieldLayout ? "tf-flex-direction--row " : "tf-flex-direction--column ") + '">', '<input control-type="tf-checkbox" id="' + this.dynamicId + '" type="checkbox" ' + (this.checked ? "checked" : "") + ">", '<label control-type="tf-chk-label" for="' + this.dynamicId + '">' + this.fieldLabel + "</label>", "</div>" ].join("\n");
            this.childTemplate = $(el)[0];
        },
        _cacheDom: function() {
        ...
        _applyProperty: function() {
            ...
            }, this), this.compClass && this.outerComp.classList.add.apply(this.outerComp.classList, this.compClass), 
            this.labelClass && this.labelComp.classList.add.apply(this.labelComp.classList, this.labelClass);
        },
        _bindEvents: function() {
            var me = this.scope;
            if ("" != this.listeners) for (var listener in this.listeners) this.innerComp.addEventListener(listener, this.listeners[listener].bind(me));
    ...
    var checkboxfield = {
        ...
        _initialize: function() {
            var me = this.scope;
            this.dynamicId = me.id || "tf-chkf-" + getRandomInt(1, 1e4), this.labelId = me.labelId || "tf-chk-label-" + getRandomInt(1, 1e4), 
            this.requiredId = "tf-chk-req-" + getRandomInt(1, 1e4), this.fieldLayout = me.fieldLayout || "row", 
            this.styles = me.styles || "", this.fieldGroup = me.fieldGroup || [], this.groupLayout = me.groupLayout || "column", 
            this.name = me.name || "", this.validations = me.validations || {}, this.validations.__proto__ = {
                isRequired: {
                    value: !1,
        ...
        _applyProperty: function() {
            "" != this.styles && Object.keys(this.styles).forEach(function(style) {
                this.outerComp.style[style] = this.styles[style];
            }, this), this.flex && (this.outerComp.style.flex = this.flex), this.compClass && this.outerComp.classList.add.apply(this.outerComp.classList, this.compClass), 
            this.labelClass && this.labelComp.classList.add.apply(this.labelComp.classList, this.labelClass), 
            this.controlClass && this.controlComp.classList.add.apply(this.controlComp.classList, this.controlClass), 
        ...
        _attachProperties: function() {
            ...
            TFLib.TFValidations.call(me.validationMethods), Object.keys(this.validations).length > 0 && this.setValidations.call(me);
        },
        _render: function() {
            var me = this.scope;
            "" != this.render && this.render.call(me);
    ...
    var container = {
        ...
        _initialize: function() {
            var me = this.scope;
            this.dynamicId = me.id || "tf-container-" + getRandomInt(1, 1e4), this.layout = me.layout || !1, 
            this.styles = me.styles || "", this.tagName = me.tagName || "div", this.flex = me.flex || "", 
            this.compClass = !!me.compClass && (me.compClass.constructor === Array ? me.compClass : [ me.compClass ]), 
        ...
        _generateTemplate: function() {
            ...
            this.layout && el.classList.add("tf-flex"), el.setAttribute("control-type", "tf-container"), 
            el.setAttribute("id", this.dynamicId), this.childTemplate = el;
        },
        _cacheDom: function() {
        ...
        _applyProperty: function() {
            ...
            "row" === this.layout ? this.outerComp.classList.add("tf-flex-direction--row") : "column" === this.layout && this.outerComp.classList.add("tf-flex-direction--column"), 
            this.innerText && (this.outerComp.innerText = this.innerText), this.innerHTML && (this.outerComp.innerHTML = this.innerHTML);
        },
        _bindEvents: function() {
            this.scope;
    ...
    return el.appendTo = function(selector, el) {
        if (el) {
    ...
    var radio = {
        ...
        _initialize: function() {
            var me = this.scope;
            this.dynamicId = me.id || "tf-radio-" + (me.attributes && me.attributes.name ? me.attributes.name : "") + getRandomInt(1, 1e4), 
            this.fieldLayout = me.fieldLayout || "row", this.styles = me.styles || "", this.attributes = me.attributes || "", 
            this.name = me.name || "", this.checked = me.checked === !0, this.fieldLabel = me.fieldLabel || "", 
            this.labelClass = !!me.labelClass && (me.labelClass.constructor === Array ? me.labelClass : [ me.labelClass ]), 
            this.compClass = !!me.compClass && (me.compClass.constructor === Array ? me.compClass : [ me.compClass ]), 
        ...
        _generateTemplate: function() {
            var el = [ '<div class="tf-field-container--control tf-flex ' + ("row" === this.fieldLayout ? "tf-flex-direction--row " : "tf-flex-direction--column ") + '">', '<input control-type="tf-radio" id="' + this.dynamicId + '" type="radio" ' + (this.checked ? "checked" : "") + 'class="tf-field--control"/>', '<label control-type="tf-radio-label" for="' + this.dynamicId + '" class="tf-field--control-lbl">' + this.fieldLabel + "</label>", "</div>" ].join("\n");
            this.childTemplate = $(el)[0];
        },
        _cacheDom: function() {
    ...
    var radiofield = {
        ...
        _initialize: function() {
            var me = this.scope;
            this.dynamicId = me.id || "tf-radiof-" + getRandomInt(1, 1e4), this.labelId = me.labelId || "tf-radio-label-" + getRandomInt(1, 1e4), 
            this.requiredId = "tf-radio-req-" + getRandomInt(1, 1e4), this.fieldLayout = me.fieldLayout || "row", 
            this.styles = me.styles || "", this.fieldGroup = me.fieldGroup || [], this.groupLayout = me.groupLayout || "column", 
            this.name = me.name || "", this.validations = me.validations || {}, this.validations.__proto__ = {
                isRequired: {
                    value: !1,
        ...
        _generateTemplate: function() {
            var el = [ '<div id="' + this.dynamicId + '"', 'class="tf-field-container tf-flex ' + ("row" === this.fieldLayout ? "tf-flex-direction--row " : "tf-flex-direction--column ") + '">', '<div control-type="tf-radiof-label" class="tf-field-container--label"' + ("none" === this.displayLabel ? "tf-display--none" : "") + '">', '<label id="' + this.labelId + '" class="tf-field--label">' + (this.fieldLabel ? this.fieldLabel : "") + "</label>", '<span id="' + this.requiredId + '" class="tf-required--red" style="display:none;">*</span>', "</div>", '<div control-type="tf-radiofield" class="tf-field-container--control tf-flex ' + ("row" === this.groupLayout ? "tf-flex-direction--row " : "tf-flex-direction--column ") + '">', "</div>", "</div>" ].join("\n");
            this.childTemplate = $(el)[0];
        },
        _cacheDom: function() {
    ...
    var textareafield = {
        ...
        _initialize: function() {
            var me = this.scope;
            this.dynamicId = me.id || "tf-ta-comp-" + getRandomInt(1, 1e4), this.innerId = me.innerId || "tf-ta-" + getRandomInt(1, 1e4), 
            this.requiredId = "tf-ta-req-" + getRandomInt(1, 1e3), this.styles = me.styles || "", 
            this.buttons = me.buttons || [], this.attributes = me.attributes || "", this.displayLabel = me.displayLabel || !1, 
            this.fieldLayout = me.fieldLayout || "row", this.validations = me.validations || {}, 
            this.validations.__proto__ = {
                ...
                regex: {
                    value: !1,
                    errmsg: "Failed regular expression"
                },
                customError: {
                    value: !1,
                    errmsg: "custom error"
        ...
        _applyProperty: function() {
            "" != this.styles && Object.keys(this.styles).forEach(function(style) {
                ...
                this.innerComp.setAttribute(attribute, this.attributes[attribute]);
            }, this), this.flex && (this.outerComp.style.flex = this.flex), this.controlClass && this.controlComp.classList.add.apply(this.controlComp.classList, this.controlClass), 
            this.labelClass && this.labelComp.classList.add.apply(this.labelComp.classList, this.labelClass), 
            this.compClass && this.outerComp.classList.add.apply(this.outerComp.classList, this.compClass), 
    ...
    var textfield = {
        ...
        _initialize: function() {
            var me = this.scope;
            this.dynamicId = me.id || "tf-textfield-" + getRandomInt(1, 1e4), this.innerId = me.innerId || me.name || "tf-input-text-" + getRandomInt(1, 1e4), 
            this.requiredId = "tf-input-req-" + getRandomInt(1, 1e3), this.buttons = me.buttons || [], 
            ...
            this.compClass = !!me.compClass && (me.compClass.constructor === Array ? me.compClass : [ me.compClass ]), 
            this.controlClass = !!me.controlClass && (me.controlClass.constructor === Array ? me.controlClass : [ me.controlClass ]), 
            this.classPrefix = me.classPrefix || "libcomp", this.name = me.name || "", this.placeholder = me.placeholder || "", 
            this.pattern = me.pattern || "", this.required = me.required === !0 ? "required" : "", 
            this.value = me.value || "", this.readOnly = me.readOnly === !0 ? "readonly" : "", 
            this.maxlength = me.maxlength || "", this.tabindex = me.tabindex || "", this.render = me.render || "", 
            this.listeners = me.listeners || "";
        },
        _generateTemplate: function() {
            var el = [ "<div", 'id="' + this.dynamicId + '"', 'class="tf-field-container tf-flex ' + ("row" === this.fieldLayout ? "tf-flex-direction--row " : "tf-flex-direction--column ") + '">', '<div control-type="tf-tf-label" class="tf-flex tf-field-container--label ' + (this.displayLabel ? "tf-display--none" : "") + '">', '<label for="' + this.innerId + '" class="tf-field--label">' + (this.fieldLabel ? this.fieldLabel : "") + "</label>", '<span id="' + this.requiredId + '" class="tf-required--red" style="display:none;">*</span>', "</div>", '<div control-type="tf-textfield" class="tf-field-container--control tf-field-with-btn">', '<input class="tf-field--control tf-flex tf-flex--one"', 'type="text"', 'id="' + this.innerId + '"', "" + (this.name ? 'name="' + this.name + '"' : ""), "" + (this.value ? 'value="' + this.value + '"' : ""), "" + (this.placeholder ? 'placeholder="' + this.placeholder + '"' : ""), "" + (this.pattern ? 'pattern="' + this.pattern + '"' : ""), "" + (this.maxlength ? 'maxlength="' + this.maxlength + '"' : ""), "" + (this.tabindex ? 'tabindex="' + this.tabindex + '"' : ""), "" + this.readOnly, "" + this.required, "/>", "</div>", "</div>" ].join("\n");
            this.childTemplate = $(el)[0];
        },
        _cacheDom: function() {
        ...
        _applyProperty: function() {
            "" != this.styles && Object.keys(this.styles).forEach(function(style) {
                ...
                this.innerComp.setAttribute(attribute, this.attributes[attribute]);
            }, this), this.controlClass && this.controlComp.classList.add.apply(this.controlComp.classList, this.controlClass), 
            this.compClass && this.outerComp.classList.add.apply(this.outerComp.classList, this.compClass), 
            this.labelClass && this.labelComp.classList.add.apply(this.labelComp.classList, this.labelClass), 
            this.flex && (this.outerComp.style.flex = this.flex), this.buttons.forEach(function(val) {
                this.controlComp.appendChild(TFLib.TFButton.call(val));
            }, this);
        },
        _bindEvents: function() {
    ...
    var loader = {
        ...
        _initialize: function() {
            var me = this.scope;
            this.dynamicId = me.id || "tf-loader-" + new Date().getTime(), this.styles = me.styles || "", 
            this.attributes = me.attributes || "", this.compClass = !!me.compClass && (me.compClass.constructor === Array ? me.compClass : [ me.compClass ]), 
        ...
        _generateTemplate: function() {
            var el = [ '<section class="tf--loader-main" id="' + this.dynamicId + '">', '<div class="tf--loader-outer">', '<div class="tf--loader" control-type="tf--loader">', '<div class="tf--loader-image">', this.LoaderImage, "</div>", '<div class="tf--loader-text">' + this.LoaderText + "</div>", "</div>", "</div>", "</section>" ].join("\n");
            this.childTemplate = $(el)[0];
        },
        _cacheDom: function() {
        ...
        _applyProperty: function() {
            ...
            this.loaderClass && this.innerComp.classList.add.apply(this.innerComp.classList, this.loaderClass), 
            this.compClass && this.outerComp.classList.add.apply(this.outerComp.classList, this.compClass);
        },
        _bindEvents: function() {
            var me = this.scope;
    ...
    var comboboxfield = {
        ...
        _initialize: function() {
            var me = this.scope;
            this.dynamicId = me.id || "tf-combo-" + getRandomInt(1, 1e4), this.labelId = me.labelId || "tf-combo-label-" + getRandomInt(1, 1e4), 
            this.requiredId = "tf-combo-req-" + getRandomInt(1, 1e4), this.buttons = me.buttons || [], 
            this.validations = me.validations || {}, this.validations.__proto__ = {
                isRequired: {
                    value: !1,
                    errmsg: "This field is Required"
        ...
        _generateTemplate: function() {
            var el = [ "<div", 'id="' + this.dynamicId + '"', 'class="tf-field-container tf-flex ' + ("row" === this.fieldLayout ? "tf-flex-direction--row " : "tf-flex-direction--column ") + '">', '<div control-type="tf-combo-label" class="tf-flex tf-field-container--label ' + (this.displayLabel ? "tf-display--none" : "") + '">', '<label id="' + this.labelId + '">' + (this.fieldLabel ? this.fieldLabel : "") + "</label>", '<span id="' + this.requiredId + '" class="tf-required--red" style="display:none;">*</span>', "</div>", '<div control-type="tf-combofield" class="tf-field-container--control tf-field-with-btn tf-flex--one" >', '<select class="tf-flex tf-flex--one"', 'type="text"', "" + (this.name ? 'name="' + this.name + '"' : ""), "" + (this.tabindex ? 'tabindex="' + this.tabindex + '"' : ""), "" + this.multiple, "></select>", "</div>", "</div>" ].join("\n");
            this.childTemplate = $(el)[0];
        },
        _cacheDom: function() {

...
TFLib.TFButtonMethods = function() {
    ...
    this.isRequired = function(e) {
        ...
        if ("blur" === e.type) "" === e.target.value || "\n" === e.target.value ? (control.classList.add("tooltip", "tf-err-border--red"), 
        ...
        control.removeAttribute("data-tooltip"), inputControl.setAttribute("title", this.validations.isRequired.errmsg)) : "" !== e.target.value && "\n" !== e.target.value || (control.classList.add("tooltip", "tf-err-border--red"), 
    ...
    var checkboxfield = {
        ...
        _handleValidationsFallback: function() {
            Object.keys(this.validations).forEach(function(val) {
                this[val].errmsg || (this[val].errmsg = this.__proto__[val].errmsg);

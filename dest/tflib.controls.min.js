...
"selectedOptions" in document.createElement("select") || Object.defineProperty(HTMLSelectElement.prototype, "selectedOptions", {
    ...
    this.displayLabelHide = function() {
        ...
        return this.isValidated = !0, this.validations && Object.keys(this.validations).forEach(function(val) {
            if ("isRequired" === val && this.validations[val].value === !0) 0 == this.innerComp.value.trim().length ? (this.controlComp.classList.addmany([ "tooltip", "tf-err-border--red" ]), 
            this.controlComp.setAttribute("data-tooltip", this.validations.isRequired.errmsg), 
            this.isValidated = !1) : this.validations.customError.value ? this.controlComp.setAttribute("data-tooltip", this.validations.customError.errmsg) : this.validations.regex.value ? this.controlComp.setAttribute("data-tooltip", this.validations.regex.errmsg) : (this.controlComp.classList.removemany([ "tooltip", "tf-err-border--red" ]), 
            this.controlComp.removeAttribute("data-tooltip")), this.isRequired.blurFirstRun = !0; else if ("regex" === val) {

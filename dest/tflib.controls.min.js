...
TFLib.TFButtonMethods = function() {
    ...
    var button = {
        ...
        _generateTemplate: function() {
            var el = [ '<div control-type="tf-btn-outer">', '<button control-type="tf-btn"', 'id="' + this.dynamicId + '"', 'class="tf-button"', "></button>", "</div>" ].join("\n");
    ...
    var comboboxfield = {
        ...
        _generateTemplate: function() {
            var el = [ '<div control-type="tf-combofield-outer"', 'id="' + this.dynamicId + '"', 'class="tf-flex ' + ("row" === this.fieldLayout ? "tf-flex-direction--row " : "tf-flex-direction--column ") + '">', '<div control-type="tf-combo-label" class="tf-flex ' + (this.displayLabel ? "tf-display--none" : "") + '">', '<label class="tf-field--label" id="' + this.labelId + '">' + (this.fieldLabel ? this.fieldLabel : "") + "</label>", '<span id="' + this.requiredId + '" class="tf-required--red" style="display:none;">*</span>', "</div>", '<div control-type="tf-combofield" class="tf-field-with-btn" >', '<select class="tf-flex tf-flex--one"', 'type="text"', "" + (this.name ? 'name="' + this.name + '"' : ""), "" + (this.tabindex ? 'tabindex="' + this.tabindex + '"' : ""), "" + this.multiple, "></select>", "</div>", "</div>" ].join("\n");
            this.childTemplate = $(el)[0];
        },
        _cacheDom: function() {

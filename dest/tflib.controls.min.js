...
TFLib.TFButtonMethods = function() {
    ...
    this.displayLabelHide = function() {
        ...
        return this.isValidated = !0, this.validations && Object.keys(this.validations).forEach(function(val) {
            ...
            this.isValidated = !1, "SELECT" === this.innerComp.tagName && this.innerComp.selectedOptions.length > 0 && "" != this.innerComp.selectedOptions[this.innerComp.selectedOptions.length - 1].value && (this.controlComp.classList.remove("tooltip", "tf-err-border--red"), 
    ...
    var textareafield = {
        ...
        _generateTemplate: function() {
            var el = [ "<div", 'id="' + this.dynamicId + '"', 'class="tf-field-container tf-flex ' + ("row" === this.fieldLayout ? "tf-flex-direction--row " : "tf-flex-direction--column ") + '">', '<div control-type="tf-taf-label" class="tf-flex tf-field-container--label " ' + (this.displayLabel ? "tf-display--none" : "") + ">", '<label for="' + this.innerId + '">' + (this.fieldLabel ? this.fieldLabel : "") + "</label>", '<span id="' + this.requiredId + '" class="tf-required--red" style="display:none;" >*</span>', "</div>", '<div control-type="tf-textareafield" class="tf-field-container--control tf-field-with-btn">', '<textarea class="tf-field--control tf-flex tf-flex--one"', 'id="' + this.innerId + '"', "" + (this.name ? 'name="' + this.name + '"' : ""), "" + (this.placeholder ? 'placeholder="' + this.placeholder + '"' : ""), "" + (this.cols ? 'cols="' + this.cols + '"' : ""), "" + (this.rows ? 'rows="' + this.rows + '"' : ""), "" + (this.maxlength ? 'maxlength="' + this.maxlength + '"' : ""), "" + this.readOnly, "" + this.required, "" + this.disabled, ">", "" + (this.value ? 'value="' + this.value + '"' : ""), "</textarea>", "</div>", "</div>" ].join("\n");
            this.childTemplate = $(el)[0];
        },
        _cacheDom: function() {

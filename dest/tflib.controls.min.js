...
"selectedOptions" in document.createElement("select") || Object.defineProperty(HTMLSelectElement.prototype, "selectedOptions", {
    ...
    this.displayLabelHide = function() {
        ...
        return this.isValidated = !0, this.validations && Object.keys(this.validations).forEach(function(val) {
            ...
            this.controlComp.setAttribute("data-tooltip", this.validations.isRequired.errmsg), 
            this.isValidated = !1) : (this.controlComp.classList.removemany([ "tooltip", "tf-err-border--red" ]), 
            this.controlComp.removeAttribute("data-tooltip", this.validations.isRequired.errmsg)), 
            this.isRequired.blurFirstRun = !0; else if ("regex" === val) {
                if (this.validations.regex.value) {
                    ...
                    this.controlComp.setAttribute("data-tooltip", this.validations.regex.errmsg), this.isValidated = !1) : this.innerComp.value.length > 0 && (this.controlComp.classList.removemany([ "tooltip", "tf-err-border--red" ]), 
    ...
    this.isRequired = function(e) {
        ...
        control.setAttribute("data-tooltip", this.validations.isRequired.errmsg)) : control.classList.contains("tooltip") && (this.validations.customError.value ? control.setAttribute("data-tooltip", this.validations.customError.errmsg) : (control.classList.removemany([ "tooltip", "tf-err-border--red" ]), 
    ...
    var loader = {
        ...
        _initialize: function() {
            ...
            this.LoaderText = me.loaderText || "Loading...", this.activeElement = document.activeElement;
        },
        _generateTemplate: function() {

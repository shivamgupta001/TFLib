...
"selectedOptions" in document.createElement("select") || Object.defineProperty(HTMLSelectElement.prototype, "selectedOptions", {
    ...
    this.isRequired = function(e) {
        ...
        control.setAttribute("data-tooltip", this.validations.isRequired.errmsg), inputControl.setAttribute("title", this.validations.isRequired.errmsg)) : control.classList.contains("tooltip") && (control.classList.removemany([ "tooltip", "tf-err-border--red" ]), 
        control.removeAttribute("data-tooltip"), inputControl.setAttribute("title", this.validations.isRequired.errmsg)); else if ("input" === e.type) controlVal.length > 0 && control.getAttribute("data-tooltip") === this.validations.isRequired.errmsg ? control.classList.contains("tooltip") && (control.classList.removemany([ "tooltip", "tf-err-border--red" ]), 
        ...
        if (this.validations.regex.value) {
            ...
            control.removeAttribute("data-tooltip"), inputControl.setAttribute("title", this.validations.regex.errmsg)) : (control.classList.addmany([ "tooltip", "tf-err-border--red" ]), 

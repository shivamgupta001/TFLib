        ...
        return this.isValidated = !0, this.validations && Object.keys(this.validations).forEach(function(val) {
            ...
            this.isRequired.blurFirstRun = !0; else if ("regex" === val) {
                if (this.validations.regex.value) {
                    ...
                    !regex.test(this.innerComp.value) && this.innerComp.value.length > 1 ? (this.controlComp.classList.addmany([ "tooltip", "tf-err-border--red" ]), 
                    this.controlComp.setAttribute("data-tooltip", this.validations.regex.errmsg), this.isValidated = !1) : (this.controlComp.classList.removemany([ "tooltip", "tf-err-border--red" ]), 

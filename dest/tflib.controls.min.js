...
DOMTokenList.prototype.addmany = function(arrClassList) {
    ...
    var checkboxfield = {
        ...
        _applyProperty: function() {
            "" != this.styles && Object.keys(this.styles).forEach(function(style) {
                this.outerComp.style[style] = this.styles[style];
            }, this), this.flex && (this.outerComp.style.flex = this.flex), this.compClass && this.outerComp.classList.addmany(this.compClass), 
            this.labelClass && this.labelComp.classList.addmany(this.labelClass), this.controlClass && this.controlComp.classList.addmany(this.controlClass), 
    ...
    var textareafield = {
        ...
        _applyProperty: function() {
            "" != this.styles && Object.keys(this.styles).forEach(function(style) {
                ...
                this.innerComp.setAttribute(attribute, this.attributes[attribute]);
            }, this), this.flex && (this.outerComp.style.flex = this.flex), this.controlClass && this.controlComp.classList.addmany(this.controlClass), 
            this.labelClass && this.labelComp.classList.addmany(this.labelClass), this.compClass && this.outerComp.classList.addmany(this.compClass), 
